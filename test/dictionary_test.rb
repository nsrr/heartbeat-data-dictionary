...
class DictionaryTest < Minitest::Test
  ...
  VALID_UNITS = ["", "beats per minute", "centimeters", "cigarettes", "days", "days from index date", "days per week", "degrees", "desaturations per hour", "events", "events per hour", "feet", "hours", "inches", "kilograms", "medications", "micro-international units per milliliter", "micrograms per milliliter", "milligrams per deciliter", "millimeters of mercury", "milliseconds", "minutes", "minutes per day", "missing items", "nanograms per milliliter", "naps", "ovaries", "percent", "periods", "picograms per milliliter", "pounds", "readings", "seconds", "units per liter", "years"]
