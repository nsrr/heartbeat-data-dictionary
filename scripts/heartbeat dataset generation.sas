...
data hbeat_total_base;
  ...
  drop hhq_date phq_date meas_date studyid namecode labelid distance exclusion01 exclusion02 exclusion03 exclusion04 exclusion05 exclusion07 exclusion08 exclusion09 exclusion10 extra_tests inclusion01 inclusion02 inclusion03 misswork nointerest nopartoth nopartoth_text partstatus passive toobusy transport;
run;
...
data hbeat_total_final;
  ...
  drop studyid namecode labelid outconc_date phq_date hhq_date;
run;
